...
const styles = StyleSheet.create({
  ...
  metricLabel: { color: "#111111", fontSize: 10, fontFamily: FONT.black, letterSpacing: 1.5 },
  metricDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: COLORS.navyLine },
  metricDotAccent: { backgroundColor: COLORS.bull },
  metricValue: { color: "#111111", fontSize: 34, fontFamily: FONT.black, letterSpacing: -0.8 },
  metricDetail: { color: "#5F5F5B", fontSize: 11, fontFamily: FONT.semiBold, },
  errorBanner: { backgroundColor: "#FFF7F7", borderWidth: 1, borderColor: "#E8B9B9", borderRadius: 8, padding: 13, marginBottom: 18 },
  errorBannerText: { color: "#111111", fontSize: 12 },
  ...
  missionNumberLabel: { color: "#111111", fontSize: 9, fontFamily: FONT.black, letterSpacing: 1.2 },
  missionNumberValue: { color: "#111111", fontSize: 23, fontFamily: FONT.black, letterSpacing: -0.5 },
  missionNumberAccent: { color: "#21864B"},
  ...
  progressLabel: { color: "#111111", fontSize: 9, fontFamily: FONT.black, letterSpacing: 1.3 },
  progressSub: { color: "#5F5F5B", fontSize: 11, marginTop: 4 },
  activeProgressPercent: { color: "#21864B", fontSize: 24, fontFamily: FONT.black, },
  ...
  missionStatLabel: { color: "#111111", fontSize: 9, fontFamily: FONT.black, letterSpacing: 1.2 },
  missionStatValue: { color: "#111111", fontSize: 16, fontFamily: FONT.extraBold, marginTop: 6 },
  missionStatValueAccent: { color: "#21864B"},
  ...
  pauseButtonText: { color: "#111111", fontSize: 9, fontFamily: FONT.black, letterSpacing: 1.2 },
  ...
  sectionTitle: { color: "#111111", fontSize: 22, fontFamily: FONT.black, letterSpacing: -0.4 },
  sectionSubtitle: { color: "#5F5F5B", fontSize: 13, marginTop: 5 },
  sectionCount: { color: "#111111", fontSize: 10, fontFamily: FONT.black, letterSpacing: 1.4 },
  ...
  dayNumber: { color: "#111111", fontSize: 10, fontFamily: FONT.black, letterSpacing: 1 },
  dayStatusDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: "#C9C9C4" },
  dayStatusDone: { backgroundColor: COLORS.bull },
  dayDate: { color: "#5F5F5B", fontSize: 10, marginTop: 5 },
  dayTarget: { color: "#111111", fontSize: 18, fontFamily: FONT.black, marginTop: 12 },
  dayDelta: { color: "#5F5F5B", fontSize: 9, marginTop: 5 },
  ...
  dayDetailTitle: { color: "#111111", fontSize: 24, fontFamily: FONT.black, },
  ...
  subsectionTitle: { color: "#111111", fontSize: 16, fontFamily: FONT.black, },
  tradeEmpty: { alignItems: "center", paddingVertical: 34 },
  tradeEmptyTitle: { color: "#111111", fontSize: 17, fontFamily: FONT.extraBold, },
  ...
  secondaryButtonText: { color: "#111111", fontSize: 9, fontFamily: FONT.black, letterSpacing: 1 },
  ...
  tradeNumber: { color: "#111111", fontSize: 11, fontFamily: FONT.black, },
  tradeInstrument: { color: "#111111", fontSize: 13, fontFamily: FONT.extraBold, },
  tradeMeta: { color: "#5F5F5B", fontSize: 10, marginTop: 3 },
  tradeCell: { minWidth: 90 },
  tableLabel: { color: "#5F5F5B", fontSize: 7, fontFamily: FONT.black, letterSpacing: 1 },
  tableValue: { color: "#111111", fontSize: 12, fontFamily: FONT.extraBold, marginTop: 4 },
  closeTradeButton: { paddingHorizontal: 12, paddingVertical: 7, borderRadius: 6, borderWidth: 1, borderColor: "#DADAD5" },
  closeTradeText: { color: "#111111", fontSize: 8, fontFamily: FONT.black, letterSpacing: 1 },
  ...
  missionCardTitle: { color: "#111111", fontSize: 21, fontFamily: FONT.black, },
  ...
  statusText: { color: "#111111", fontSize: 8, fontFamily: FONT.black, letterSpacing: 0.9 },
  ...
  targetLabel: { color: "#5F5F5B", fontSize: 8, fontFamily: FONT.black, letterSpacing: 1.2, marginBottom: 5 },
  targetValue: { color: "#111111", fontSize: 20, fontFamily: FONT.extraBold, },
  targetArrow: { color: "#111111", fontSize: 21, marginHorizontal: 20, marginBottom: 1 },
  targetRight: { alignItems: "flex-end", marginLeft: "auto" },
  targetValueTarget: { color: "#111111", fontSize: 20, fontFamily: FONT.black, },
  smallProgressHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: 19, marginBottom: 8 },
  smallProgressLabel: { color: "#5F5F5B", fontSize: 8, fontFamily: FONT.black, letterSpacing: 1.1 },
  smallProgressPercent: { color: "#111111", fontSize: 10, fontFamily: FONT.black, },
  ...
  missionMetricLabel: { color: "#5F5F5B", fontSize: 8, fontFamily: FONT.black, letterSpacing: 1 },
  missionMetricValue: { color: "#111111", fontSize: 13, fontFamily: FONT.extraBold, marginTop: 5 },
  ...
  activateButtonText: { color: "#111111", fontSize: 9, fontFamily: FONT.black, letterSpacing: 1.1 },
  activateArrow: { color: "#111111", fontSize: 15 },
  ...
  emptyIconText: { color: "#111111", fontSize: 28, fontFamily: FONT.black, },
  emptyTitle: { color: "#111111", fontSize: 22, fontFamily: FONT.black, },
  ...
  foundationEyebrow: { color: "#5F5F5B", fontSize: 9, fontFamily: FONT.black, letterSpacing: 1.5 },
  foundationTitle: { color: "#111111", fontSize: 25, fontFamily: FONT.black, marginTop: 8 },
  ...
  foundationPointTitle: { color: "#111111", fontSize: 9, fontFamily: FONT.black, letterSpacing: 1.1 },
  ...
  modalEyebrow: { color: "#5F5F5B", fontSize: 9, fontFamily: FONT.black, letterSpacing: 1.5 },
  modalTitle: { color: "#111111", fontSize: 30, fontFamily: FONT.black, marginTop: 5 },
  ...
  closeButtonText: { color: "#111111", fontSize: 25, lineHeight: 28 },
  inputGroup: { marginBottom: 17 },
  inputLabel: { color: "#111111", fontSize: 9, fontFamily: FONT.black, letterSpacing: 1.2, marginBottom: 8 },
  input: { height: 48, borderRadius: 8, backgroundColor: COLORS.glassBg, borderWidth: 1, borderColor: "#DCDCD7", color: "#111111", fontSize: 14, paddingHorizontal: 14, outlineStyle: "none" } as any,
  ...
  choiceText: { color: "#111111", fontSize: 9, fontFamily: FONT.black, letterSpacing: 0.8 },
  choiceTextSelected: { color: "#21864B"},
  previewCard: { backgroundColor: "#FAF8FF", borderWidth: 1, borderColor: "#DCD4F1", borderRadius: 9, padding: 16, marginBottom: 18 },
  previewEyebrow: { color: "#5F5F5B", fontSize: 8, fontFamily: FONT.black, letterSpacing: 1.3, marginBottom: 13 },
  previewRow: { flexDirection: "row", flexWrap: "wrap", gap: 25 },
  previewMetric: { flex: 1, minWidth: 120 },
  previewMetricLabel: { color: "#5F5F5B", fontSize: 8, fontFamily: FONT.black, letterSpacing: 1 },
  previewMetricValue: { color: "#111111", fontSize: 20, fontFamily: FONT.black, marginTop: 5 },
  exitEstimate: { color: "#111111", fontSize: 28, fontFamily: FONT.black, },
  modalError: { backgroundColor: "#FFF7F7", borderWidth: 1, borderColor: "#E8B9B9", borderRadius: 8, padding: 12, marginBottom: 14 },
  modalErrorText: { color: "#111111", fontSize: 12, lineHeight: 18 },
  ...
  cancelButtonText: { color: "#111111", fontSize: 10, fontFamily: FONT.black, letterSpacing: 1 },
});
